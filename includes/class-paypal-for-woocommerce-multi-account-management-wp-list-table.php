<?php
/**
 * Administration API: Paypal_For_Woocommerce_Multi_Account_Management_WP_List_Table class
 *
 * @package WordPress
 ...
 * @access private
 */
class Paypal_For_Woocommerce_Multi_Account_Management_WP_List_Table {
    ...
    public function ajax_user_can() {
        die('function Paypal_For_Woocommerce_Multi_Account_Management_WP_List_Table::ajax_user_can() must be over-ridden in a sub-class.');
    }

    /**
     * Prepares the list of items for displaying.
     * @uses Paypal_For_Woocommerce_Multi_Account_Management_WP_List_Table::set_pagination_args()
     *
     * @since 3.1.0
     * @access public
     * @abstract
    ...
    public function prepare_items() {
        die('function Paypal_For_Woocommerce_Multi_Account_Management_WP_List_Table::prepare_items() must be over-ridden in a sub-class.');
    }
    ...
    /**
     * Get a list of CSS classes for the Paypal_For_Woocommerce_Multi_Account_Management_WP_List_Table table tag.
     *
     * @since 3.1.0
     * @access protected
     *
