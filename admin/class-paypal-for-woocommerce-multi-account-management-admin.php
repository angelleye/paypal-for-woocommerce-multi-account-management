...
class Paypal_For_Woocommerce_Multi_Account_Management_Admin {
            ...
            foreach ($microprocessing as $microprocessing_key => $microprocessing_value) {
                switch ($microprocessing_key) {
                    ...
                    case 'woocommerce_paypal_express_brand_name':
                        echo sprintf('<tr><th scope="row" class="titledesc"><label for="woocommerce_paypal_express_brand_name_microprocessing">%1$s</label></th><td class="forminp"><fieldset><input class="input-text regular-input width460" name="woocommerce_paypal_express_brand_name" value="%2$s" id="woocommerce_paypal_express_brand_name_microprocessing" style="" placeholder="" type="text">%3$s</fieldset></td></tr>', __('Brand Name', 'paypal-for-woocommerce-multi-account-management'), !empty($microprocessing_value[0]) ? $microprocessing_value[0] : '', __('This controls what users see as the brand / company name on PayPal review pages.', 'paypal-for-woocommerce'));
                        break;
                     case 'woocommerce_paypal_express_checkout_logo':
                        echo sprintf('<tr><th scope="row" class="titledesc"><label for="woocommerce_paypal_express_checkout_logo_microprocessing">%1$s</label></th><td class="forminp"><fieldset><input class="input-text regular-input width460" name="woocommerce_paypal_express_checkout_logo" value="%2$s" id="woocommerce_paypal_express_checkout_logo_microprocessing" style="" placeholder="" type="text">%3$s</fieldset></td></tr>', __('PayPal Checkout Logo (190x60px)', 'paypal-for-woocommerce-multi-account-management'), !empty($microprocessing_value[0]) ? $microprocessing_value[0] : '', __('This controls what users see as the logo on PayPal review pages. ', 'paypal-for-woocommerce') . $require_ssl);
                        break;
                    case 'woocommerce_paypal_express_checkout_logo_hdrimg':
                        echo sprintf('<tr><th scope="row" class="titledesc"><label for="woocommerce_paypal_express_checkout_logo_hdrimg_microprocessing">%1$s</label></th><td class="forminp"><fieldset><input class="input-text regular-input width460" name="woocommerce_paypal_express_checkout_logo_hdrimg" value="%2$s" id="woocommerce_paypal_express_checkout_logo_hdrimg_microprocessing" style="" placeholder="" type="text">%3$s</fieldset></td></tr>', __('PayPal Checkout Logo (190x60px)', 'paypal-for-woocommerce-multi-account-management'), !empty($microprocessing_value[0]) ? $microprocessing_value[0] : '', __('This controls what users see as the header banner on PayPal review pages. ', 'paypal-for-woocommerce') . $require_ssl);
                        break;
                     case 'woocommerce_paypal_express_customer_service_number':
                        echo sprintf('<tr><th scope="row" class="titledesc"><label for="woocommerce_paypal_express_customer_service_number_microprocessing">%1$s</label></th><td class="forminp"><fieldset><input class="input-text regular-input width460" name="woocommerce_paypal_express_customer_service_number" value="%2$s" id="woocommerce_paypal_express_customer_service_number_microprocessing" style="" placeholder="" type="text">%3$s</fieldset></td></tr>', __('Customer Service Number', 'paypal-for-woocommerce-multi-account-management'), !empty($microprocessing_value[0]) ? $microprocessing_value[0] : '', __('This controls what users see for your customer service phone number on PayPal review pages.', 'paypal-for-woocommerce'));
                        break;
                     case 'woocommerce_paypal_express_softdescriptor':
                        echo sprintf('<tr><th scope="row" class="titledesc"><label for="woocommerce_paypal_express_softdescriptor_microprocessing">%1$s</label></th><td class="forminp"><fieldset><input class="input-text regular-input width460" name="woocommerce_paypal_express_softdescriptor" value="%2$s" id="woocommerce_paypal_express_softdescriptor_microprocessing" style="" placeholder="" type="text">%3$s</fieldset></td></tr>', __('Credit Card Statement Name', 'paypal-for-woocommerce-multi-account-management'), !empty($microprocessing_value[0]) ? $microprocessing_value[0] : '', __('The value entered here will be displayed on the buyer\'s credit card statement.', 'paypal-for-woocommerce'));
                        break;
    ...
    public function angelleye_multi_account_api_field_ui() {
        ...
        <tr class="angelleye_multi_account_paypal_express_field">
            <th scope="row" class="titledesc" >
                <label for="woocommerce_paypal_express_checkout_logo_microprocessing"><?php echo __('PayPal Checkout Logo (190x60px)', 'paypal-for-woocommerce-multi-account-management'); ?></label>
            </th>
            <td class="forminp">
                <fieldset>
